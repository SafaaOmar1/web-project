...
include ($webroot .'aPages/dierectory/update.ctrl.php');
...
?>
    ...
    <body><div class="form-style-5">
        <form  class="form-inline" action="<?=$webroot?>aPages/dierectory/update.php" method="post">
            <fieldset>
                <legend><span class="number">1</span> Update person information !</legend>
