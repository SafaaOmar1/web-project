...
include ($webroot .'aPages/dierectory/add.ctrl.php');
...
<body><div class="form-style-5">
    <form  class="form-inline" action="<?=$webroot?>aPages/dierectory/add.php" method="post">
        <fieldset>
            <legend><span class="number">1</span> ADD person information !</legend>
