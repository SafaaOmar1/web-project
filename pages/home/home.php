...
<center><strong><span
    ...
    <div>
        ...
        <div class="circle col-md-3" style=" 10px;">
            ...
            <b>  <a href="<?= $webroot.'pages/campaign/adv.php'?>">  <br>
                    <center>
                        <b>
        ...
        <div class="circle col-md-3" style=" 10px;">
                    ...
                    <b>  <a href="<?= $webroot.'pages/search/search.view.php' ?>">  <br>
            <center>
                <b>
        ...
        <div class="circle col-md-3" style=" 10px;" href="">
            ...
            <b>  <a href="<?= $webroot.'pages/issueReporting/report.php'?>">  <br>
                    <center>
                        <b>
        ...
        <div class="circle col-md-3" style=" 10px;">
            ...
            <b>  <a href="<?=$webroot.'pages/TrainingApp/work.php'?>">  <br>
                    <center>
                        <b>
